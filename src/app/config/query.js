...
export async function extractEntityFromQuery(query) {
  try {
    const prompt = {
      ...
      examples: [
        {
          query: "Cho tôi thông tin của nhân viên tên Lê Văn Thảo",
          intent: "get_employee_info",
          entity: "Lê Văn Thảo",
        },
        {
          query: "Tôi muốn biết về nhân viên tên Nguyễn Văn A",
          intent: "get_employee_info",
          entity: "Nguyễn Văn A",
        },
        {
          query: "Ai là người tên Trần Thị Bích Ngọc?",
          intent: "get_employee_info",
          entity: "Trần Thị Bích Ngọc",
        },
        {
          query: "Ai là người có email thu@gmail.com?",
          intent: "get_employee_info",
          entity: "thu@gmail.com",
        },
      ],
    };
